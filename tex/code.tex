...
\end{minted}
\newpage
\subsection*{test\_middlebury.ipynb}
\begin{minted}[breaklines,fontsize=\footnotesize]{python}
...
from PIL import Image
import cv2
gt = cv2.imread("D:\\Weeks\\ai_stereo\\RAFT-Stereo-main\\datasets
                \\Middlebury\\MiddEval3\\trainingQ\\Carla\\depth004788.png",flags = cv2.IMREAD_COLOR)
#gt.show()
gt = np.array(gt)
#img = Image.fromarray(gt.astype('uint8'),'L')
#plt.imshow(img)
